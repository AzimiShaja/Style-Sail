        ...
        return (
          ...
          >
            <div
              ...
              className="category-body-container bg-gray-100 opacity-60 hover:opacity-100 duration-300 rounded-md p-4 border box-border border-black flex flex-col items-center gap-1"
            >
